  ...
  test("it should mount", () => {
    ...
    render(
      <Provider store={store}>
        <SearchSidebarContent setQuery={setQuery} />
      </Provider>
    );

    const searchSidebarContent = screen.getByText("General site details");

    expect(searchSidebarContent).toBeInTheDocument();
  });
