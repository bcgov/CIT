...
def import_data_sources():
    DATA_SOURCES = ['data/import/bucket2/semiannually/2municipalities.json', 'data/import/bucket2/semiannually/2northern_rockies_census_division.json', 'data/import/bucket2/semiannually/2regional_districts.json', 'data/import/bucket2/semiannually/2school_districts.json', 'data/import/bucket2/semiannually/2tsunami_zones.json', 'data/import/bucket2/semiannually/2wildfires_zones.json']
