...
urlpatterns = [
    ...
    url(r"^locations/natural_resource_projects/$",
        pipeline.views.location_types.NaturalResourceProjectList.as_view()),
    url(r"^locations/economic_projects/$",
        pipeline.views.location_types.EconomicProjectList.as_view()),
    ...
    url(r"^opportunities/$",
        pipeline.views.opportunity.OpportunitiesList.as_view(),
        name="opportunities")
]
