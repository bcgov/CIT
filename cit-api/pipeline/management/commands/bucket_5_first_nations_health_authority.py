...
from pipeline.importers.bucket5_first_nations_health_authority import import_data_sources
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        data_resources = DataSource.objects.filter(name__in=[
            'first_nations_health_authority'
        ])
        ...
        print("Import process for bucket5_first_nations_health_authority completed!")