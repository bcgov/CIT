...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        data_resources = DataSource.objects.filter(name__in=[
            'census_economic_region', 'courts',  'health_authority_boundaries', 'indian_reserve_and_band_name', 'lakes', 'natural_resource_regions', 'post_secondary_institutions', 'provincial_electoral_district', 'railways', 'research_centres', 'rivers', 'road_and_highways', 'services'
        ])
