from pipeline.importers.bucket5.bucket5_emergency_social_service_facilities import (
    import_data_sources,
)
...
class Command(BaseImportCommand):
    ...
    def handle(self, *args, **options):
        ...
        data_resources = DataSource.objects.filter(
            name__in=['emergency_social_service_facilities']
        )
        ...
        print(
            "Import process for bucket5_emergency_social_service_facilities completed!"
        )
