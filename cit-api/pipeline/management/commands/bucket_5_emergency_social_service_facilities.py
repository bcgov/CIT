...
from pipeline.importers.bucket5.bucket5_emergency_social_service_facilities import import_data_sources
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print("Import process for bucket5_emergency_social_service_facilities completed!")