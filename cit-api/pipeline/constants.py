...
OPENCA_METADATA_API_URL = (
    'https://open.canada.ca/data/api/action/package_show?id={dataset_resource_id}'
)
...
POWERBI_HIDDEN_DETAIL_PAGES = [
    POWERBI_DET_DEMOGRAPHICS_DET,
    POWERBI_DET_DEMOGRAPHICS_CMP,
    POWERBI_DET_EDUCATION_CMP,
    POWERBI_DET_INCOME_DET,
    POWERBI_DET_INCOME_CMP,
    POWERBI_DET_HOUSING_DET,
    POWERBI_DET_HOUSING_CMP,
]

POWERBI_HIDDEN_EXPLORE_PAGES = [
    POWERBI_AGG_DOMESTIC,
    POWERBI_AGG_EDUCATION,
    POWERBI_AGG_INCOME,
]
