...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pipeline', '0146_firstnationshealthauthoritysite'),
    ]
    ...
    operations = [
        ...
        SELECT o.id AS opportunity_id,
            ...
            o.elevation_at_location AS lation_elevation,
            ...
            ( SELECT a.aerodrome_status
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS aerodrome_status,
            ( SELECT a.aircraft_access_ind
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS acraft_access_ind,
            ( SELECT a.elevation
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS elevation,
            ( SELECT a.fuel_availability_ind
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS fuel_availability_ind,
            ( SELECT a.helicopter_access_ind
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS helicopter_access_ind,
            ( SELECT a.max_runway_length
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS max_runway_length,
            ( SELECT a.number_of_runways
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS number_of_runways,
            ( SELECT a.runway_surface
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS oil_availability_ind,
            ( SELECT a.oil_availability_ind
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS seaplane_access_ind,
            ( SELECT a.seaplane_access_ind
                FROM pipeline_airportdistance d,
                    pipeline_airport a
                WHERE d.id = o.nearest_airport AND d.airport_id = a.location_ptr_id) AS aport_distance,
