...
class Opportunity(models.Model):
    ...
    approval_status = models.ForeignKey(
        ApprovalStatus, default="PEND", to_field="status_code", on_delete=models.PROTECT
    )
    ...
    opportunity_preferred_development_v2 = models.CharField(
    ...
    nearest_municipalities = models.ManyToManyField(
        MunicipalityDistance, db_column="nearest_municipalities", blank=True
    )
    nearest_first_nations = models.ManyToManyField(
        IndianReserveBandDistance, db_column="nearest_first_nations", blank=True
    )
    ...
    nearest_research_centre = models.ForeignKey(
    ...
    nearest_fire_station = models.ForeignKey(
    ...
    nearest_police_station = models.ForeignKey(
        FirstResponderDistance,
    ...
    nearest_ambulance_station = models.ForeignKey(
        FirstResponderDistance,
    ...
    nearest_coast_guard_station = models.ForeignKey(
        FirstResponderDistance,
    ...
    nearest_post_secondary = models.ForeignKey(
    ...
    elevation_at_location = models.DecimalField(
    ...
    # Services
    # Road
    opportunity_road_connected = models.CharField(
        blank=False, null=False, default="U", max_length=1, choices=ACCESS_CHOICES
    )
    # Water
    opportunity_water_connected = models.CharField(
        blank=False, null=False, default="U", max_length=1, choices=ACCESS_CHOICES
    )
    opportunity_water_capacity = models.DecimalField(
        max_digits=7, decimal_places=3, blank=True, null=True
    )
    # Sewer
    opportunity_sewer_connected = models.CharField(
        blank=False, null=False, default="U", max_length=1, choices=ACCESS_CHOICES
    )
    opportunity_sewer_capacity = models.DecimalField(
        max_digits=7, decimal_places=3, blank=True, null=True
    )
    # Natural Gase
    opportunity_natural_gas_connected = models.CharField(
        blank=False, null=False, default="U", max_length=1, choices=ACCESS_CHOICES
    )
    opportunity_natural_gas_capacity = models.DecimalField(
        max_digits=7, decimal_places=3, blank=True, null=True
    )
    # Electric
    opportunity_electrical_connected = models.CharField(
        blank=False, null=False, default="U", max_length=1, choices=ACCESS_CHOICES
    )
    opportunity_electrical_capacity = models.DecimalField(
        max_digits=7, decimal_places=3, blank=True, null=True
    )
