...
from pipeline.views.options import (
    CensusEconomicRegionOptions,
    CensusSubdivisionOptions,
    CommunityOptions,
    HealthAuthorityBoundaryOptions,
    NaturalResourceRegionOptions,
    OptionsView,
    RegionalDistrictOptions,
    SchoolDistrictOptions,
    TourismRegionOptions,
    TsunamiZoneOptions,
    WildfireZoneOptions,
)
...
urlpatterns = [
    ...
    re_path(
        r"^options/census-economic-regions/$", CensusEconomicRegionOptions.as_view()
    ),
    ...
    re_path(
        r"^options/health-authority-boundaries/$",
        HealthAuthorityBoundaryOptions.as_view(),
    ),
    re_path(
        r"^options/natural-resource-regions/$", NaturalResourceRegionOptions.as_view()
    ),
    ...
    re_path(
        r"^user/tracking/$", pipeline.views.users.tracking.UserTrackingView.as_view()
    ),
]
