...
| **Bucket 2** | CoreHousingImporter                        | `bucket2/bucket2_core_housing_need.py`              | `pipeline_csdcorehousingneed`                  | Statistics Canada Housing Data       |
...
| **Bucket 2** | PHDemographicDistributionImporter          | `bucket2/bucket2_phdemographic.py`                  | `pipeline_phdemographicdistribution`           | Manual CSV (dbuid_csduid.csv)        |
...
| **Bucket 2** | RegionalDistrictsImporter                  | `bucket2/bucket2_regional_districts.py`             | `pipeline_regionaldistrict`                    | BC Data Catalogue (DataBC)           |
| **Bucket 2** | MunicipalitiesImporter                     | `bucket2/bucket2_municipalities.py`                 | `pipeline_municipality`                        | BC Data Catalogue (DataBC)           |
| **Bucket 2** | SchoolDistrictsImporter                    | `bucket2/bucket2_school_districts.py`               | `pipeline_schooldistrict`                      | BC Data Catalogue (DataBC)           |
| **Bucket 2** | TourismRegionImporter                      | `bucket2/bucket2_tourism_region.py`                 | `pipeline_tourismregion`                       | BC Data Catalogue (DataBC)           |
| **Bucket 2** | WildfiresZonesImporter                     | `bucket2/bucket2_wildfire_zones.py`                 | `pipeline_wildfirezone`                        | BC Data Catalogue (DataBC)           |
| **Bucket 2** | TsunamiZonesImporter                       | `bucket2/bucket2_tsunami_zones.py`                  | `pipeline_tsunamizone`                         | BC Data Catalogue (DataBC)           |
| **Bucket 2** | ConnectivityInfrastructureProjectsImporter | `bucket2/bucket2_connectivity_projects.py`          | `pipeline_connectivityinfrastructureprojects`  | BC Data Catalogue (DataBC)           |
| **Bucket 2** | HousingImporter                            | `bucket2/bucket2_housing.py`                        | `pipeline_housing`                             | BC Data Catalogue (DataBC)           |
| **Bucket 2** | MunicipalTaxRatesImporter                  | `bucket2/bucket2_municipal_tax_rates.py`            | `pipeline_municipaltaxrates`                   | BC Data Catalogue (DataBC)           |
| **Bucket 2** | SmallBusinessesImporter                    | `bucket2/bucket2_small_businesses.py`               | `pipeline_csdsmallbusiness`                    | BC Data Catalogue (DataBC)           |
| **Bucket 2** | NaicsCodesImporter                         | `bucket2/bucket2_naics_codes.py`                    | `pipeline_naicscodes`                          | BC Data Catalogue (DataBC)           |
